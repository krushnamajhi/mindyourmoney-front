...
export const ExpenseRow = memo(function ExpenseRow({ expense, style, onClick }: ExpenseRowProps) {
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-1">
                        ...
                        {expense.group && (
                            <div className="flex items-center space-x-1">
                                <span className="text-slate-300">•</span>
                                <div className="flex items-center space-x-1 px-2 py-0.5 bg-orange-50 text-orange-700 rounded-full text-xs font-medium">
                                    <Users size={10} />
